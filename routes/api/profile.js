...
router.post("/", [auth, [check("status", "Status is required").not().isEmpty(), check("skills", "Skills is required").not().isEmpty()]], async (req, res) => {
  ...
  // Buid profile object
  const profileFields = {};
  // adding the information to profile fields
  ...
  if (skills) {
    // it will be a comma separeated list which need to be turned into an array
...
// this will get all the profiles
...
router.get("/user/:user_id", async (req, res) => {
  try {
    ...
    // this will check if the error is they dont have an id
...
// @access   Private
// this will delete the user and the profile
...
// we are updating part of a profile so it is a put request
